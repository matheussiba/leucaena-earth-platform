window.LeucenaI18n = (function () {
  ...
  const T = {
    ...
    'auth.termsRequired': { pt: 'Aceite os Termos de Uso para continuar', en: 'Please accept the Terms of Use to continue', es: 'Acepte los Términos de Uso para continuar' },
    'auth.termsAccept': { pt: 'Li e concordo com os ', en: 'I have read and agree to the ', es: 'He leído y acepto los ' },
    'auth.termsLink': { pt: 'Termos de Uso e Política de Privacidade', en: 'Terms of Use and Privacy Policy', es: 'Términos de Uso y Política de Privacidad' },
    'googleWelcome.title': { pt: 'Bem-vindo(a) ao leucaena.earth!', en: 'Welcome to leucaena.earth!', es: '¡Bienvenido(a) a leucaena.earth!' },
    'googleWelcome.body': { pt: 'Sua conta foi criada com sucesso usando o Google.', en: 'Your account was created successfully using Google.', es: 'Su cuenta fue creada con éxito usando Google.' },
    'googleWelcome.consent': { pt: 'Ao continuar, você confirma que leu e concorda com nossos ', en: 'By continuing, you confirm that you have read and agree to our ', es: 'Al continuar, confirma que ha leído y acepta nuestros ' },
    'googleWelcome.continue': { pt: 'Concordar e continuar', en: 'Agree and continue', es: 'Aceptar y continuar' },
    ...
    'auth.verifyEmailSent': { pt: 'Um e-mail de verificação foi enviado para {0}. Verifique sua caixa de entrada e, se não encontrar, a pasta de spam ou lixo eletrônico.', en: 'A verification email was sent to {0}. Check your inbox and your spam or junk folder if you don\'t see it.', es: 'Se envió un correo de verificación a {0}. Revise su bandeja de entrada y, si no lo ve, la carpeta de spam o correo no deseado.' },
    ...
    'auth.sessionExpired': { pt: 'Sua sessão expirou. Faça login novamente.', en: 'Your session has expired. Please log in again.', es: 'Su sesión ha expirado. Inicie sesión nuevamente.' },
    ...
    'auth.resendSuccess': { pt: 'E-mail de verificação reenviado! Confira a caixa de entrada e a pasta de spam, se necessário.', en: 'Verification email resent! Check your inbox and spam folder if needed.', es: '¡Correo de verificación reenviado! Revise la bandeja de entrada y la carpeta de spam si hace falta.' },
    'auth.verificationRequired': { pt: 'Verifique seu e-mail para poder editar o mapa. Se não recebeu, confira a pasta de spam ou lixo eletrônico.', en: 'Verify your email to edit the map. If you didn\'t receive it, check your spam or junk folder.', es: 'Verifique su correo para editar el mapa. Si no lo recibió, revise spam o correo no deseado.' },
    'auth.emailNotVerifiedAction': { pt: 'Verifique seu e-mail antes de usar esta função. Confira também a pasta de spam.', en: 'Verify your email before using this feature. Check your spam folder too.', es: 'Verifique su correo antes de usar esta función. Revise también la carpeta de spam.' },
    'auth.verifyLinkSent': { pt: 'Enviamos um link de verificação para {0}. Verifique sua caixa de entrada e a pasta de spam ou lixo eletrônico.', en: 'We sent a verification link to {0}. Check your inbox and spam or junk folder.', es: 'Enviamos un enlace de verificación a {0}. Revise su bandeja y la carpeta de spam o correo no deseado.' },
    'auth.verifyLinkRecentlySent': { pt: 'Um link de verificação já foi enviado para {0}. Verifique sua caixa de entrada e a pasta de spam, ou aguarde 2 minutos.', en: 'A verification link was already sent to {0}. Check your inbox and spam folder, or wait 2 minutes.', es: 'Ya se envió un enlace de verificación a {0}. Revise su bandeja y spam, o espere 2 minutos.' },
    'auth.accountNotVerifiedTitle': { pt: 'Conta não verificada', en: 'Account not verified', es: 'Cuenta no verificada' },
    'auth.accountNotVerifiedBody': { pt: 'Sua conta ainda não foi ativada. O link foi enviado para {0}. Verifique a caixa de entrada e o spam.', en: 'Your account is not active yet. The link was sent to {0}. Check your inbox and spam.', es: 'Su cuenta aún no está activa. El enlace se envió a {0}. Revise la bandeja de entrada y spam.' },
    'auth.unverifiedResendNeedIdentifier': { pt: 'Informe o mesmo usuário ou e-mail que você usou no cadastro.', en: 'Enter the same username or email you used to register.', es: 'Ingrese el mismo usuario o correo que usó al registrarse.' },
    ...
    'unlock.finishEditing': { pt: 'Finalizar edição', en: 'Finish editing', es: 'Finalizar edición' },
    'unlock.subtitleContributor': { pt: 'Salve o progresso e libere a célula. Só a equipe pode marcar como finalizada.', en: 'Save your progress and release the cell. Only the team can mark it as finished.', es: 'Guarda el progreso y libera la celda. Solo el equipo puede marcarla como finalizada.' },
    ...
    'update.reloading': { pt: 'Recarregando em {0}s...', en: 'Reloading in {0}s...', es: 'Recargando en {0}s...' },
    'update.reload': { pt: 'Recarregar agora', en: 'Reload now', es: 'Recargar ahora' },
    'update.bannerTitle': { pt: 'Nova versão disponível.', en: 'New version available.', es: 'Nueva versión disponible.' },
    'update.bannerHint': { pt: 'Recarregue quando puder — seu trabalho foi salvo.', en: 'Reload when ready — your work has been saved.', es: 'Recargue cuando pueda — su trabajo fue guardado.' },
    ...
    'sidebar.qcUnreviewed': { pt: 'Não revisados', en: 'Unreviewed', es: 'No revisados' },
    'sidebar.qcFlagged': { pt: 'Marcados', en: 'Flagged', es: 'Marcados' },
    'sidebar.qcRejected': { pt: 'Rejeitados', en: 'Rejected', es: 'Rechazados' },
    'sidebar.qcApproved': { pt: 'Aprovados', en: 'Approved', es: 'Aprobados' },
    ...
    'cellSearch.placeholder': { pt: 'ID da célula (ex.: 42 ou UF-42-1-3)', en: 'Cell ID (e.g. 42 or ST-42-1-3)', es: 'ID de celda (ej.: 42 o UF-42-1-3)' },
    'cellSearch.goTitle': { pt: 'Ir para célula', en: 'Go to cell', es: 'Ir a celda' },
    'cellSearch.notFound': { pt: 'Nenhuma célula encontrada para "{0}".', en: 'No cell found for "{0}".', es: 'No se encontró celda para "{0}".' },
    'cellSearch.unlockFirst': { pt: 'Desbloqueie a célula atual antes de ir para outra.', en: 'Unlock the current cell before navigating to another.', es: 'Desbloquea la celda actual antes de ir a otra.' },
    'cellSearch.unlockFirstMulti': { pt: 'Desbloqueie a célula atual antes de buscar várias células.', en: 'Unlock the current cell before searching multiple cells.', es: 'Desbloquea la celda actual antes de buscar varias celdas.' },
    'cellSearch.multipleFound': { pt: '{0} células encontradas.', en: '{0} cells found.', es: '{0} celdas encontradas.' },
    ...
    'sidebar.mappedBy': { pt: 'Polígonos desenhados por:', en: 'Polygons drawn by:', es: 'Polígonos dibujados por:' },
    'sidebar.lockHistory': { pt: 'Quem abriu a célula (log):', en: 'Who opened this cell (log):', es: 'Quién abrió la celda (registro):' },
    'sidebar.maskBreakdownTitle': { pt: 'Polígonos por colaborador', en: 'Polygons per contributor', es: 'Polígonos por colaborador' },
    'sidebar.maskBreakdownLine': { pt: '{0}: {1} polígono(s), {2} ha', en: '{0}: {1} polygon(s), {2} ha', es: '{0}: {1} polígono(s), {2} ha' },
    ...
    'sidebar.qcReviewCell': { pt: 'Modo Revisão', en: 'Review Mode', es: 'Modo Revisión' },
    'sidebar.unlockCell': { pt: 'Desbloquear célula', en: 'Unlock cell', es: 'Desbloquear celda' },
    'sidebar.onlineUsers': { pt: 'Usuários Online', en: 'Online Users', es: 'Usuarios en Línea' },
    'sidebar.chooseState': { pt: 'Escolha um estado para visualizar detalhes do mapeamento', en: 'Choose a state to view mapping details', es: 'Elija un estado para ver detalles del mapeo' },
    'sidebar.chooseStateBtn': { pt: 'Selecionar região', en: 'Select region', es: 'Seleccionar región' },
    'sidebar.brazilOverviewTitle': { pt: 'Visão geral por estado', en: 'Per-state overview', es: 'Visión general por estado' },
    'sidebar.brazilTotalArea': { pt: 'Área mapeada', en: 'Mapped area', es: 'Área mapeada' },
    'sidebar.brazilTotalPolys': { pt: 'Polígonos', en: 'Polygons', es: 'Polígonos' },
    'sidebar.brazilTotalCells': { pt: 'Células', en: 'Cells', es: 'Celdas' },
    'sidebar.brazilTotalFinished': { pt: 'Finalizadas', en: 'Finished', es: 'Finalizadas' },
    'sidebar.brazilSortBy': { pt: 'Ordenar:', en: 'Sort:', es: 'Ordenar:' },
    'sidebar.brazilSortArea': { pt: 'Área mapeada', en: 'Mapped area', es: 'Área mapeada' },
    'sidebar.brazilSortPolys': { pt: 'Polígonos', en: 'Polygons', es: 'Polígonos' },
    'sidebar.brazilSortPct': { pt: '% Finalizado', en: '% Finished', es: '% Finalizado' },
    'sidebar.brazilSortPoints': { pt: 'Pontos', en: 'Points', es: 'Puntos' },
    'sidebar.brazilSortName': { pt: 'Nome', en: 'Name', es: 'Nombre' },
    'sidebar.brazilLoading': { pt: 'Carregando estatísticas…', en: 'Loading statistics…', es: 'Cargando estadísticas…' },
    'sidebar.brazilNoData': { pt: 'Sem dados de mapeamento ainda', en: 'No mapping data yet', es: 'Sin datos de mapeo aún' },
    'sidebar.brazilStateRowTitle': { pt: 'Abrir mapa de {name}', en: 'Open map of {name}', es: 'Abrir mapa de {name}' },

    // ── Phase 6 — QC review (admin) ──
    'qc.reviewBtnTitle': { pt: 'Modo Revisão de Polígonos', en: 'Polygon QC Review Mode', es: 'Modo de Revisión de Polígonos' },
    'qc.pickerTitle': { pt: 'Modo Revisão de Polígonos', en: 'Polygon QC Review Mode', es: 'Modo de Revisión de Polígonos' },
    'qc.pickerHint': { pt: 'Escolha uma célula para revisar os polígonos enviados por colaboradores.', en: 'Pick a cell to review polygons submitted by contributors.', es: 'Elija una celda para revisar los polígonos enviados por colaboradores.' },
    'qc.statusFilter': { pt: 'Status:', en: 'Status:', es: 'Estado:' },
    'qc.status.unreviewed': { pt: 'Não revisados', en: 'Unreviewed', es: 'No revisados' },
    'qc.status.approved': { pt: 'Aprovados', en: 'Approved', es: 'Aprobados' },
    'qc.status.flagged': { pt: 'Marcados', en: 'Flagged', es: 'Marcados' },
    'qc.status.rejected': { pt: 'Rejeitados', en: 'Rejected', es: 'Rechazados' },
    'qc.pickerEmpty': { pt: 'Nenhuma célula com polígonos para esse status.', en: 'No cells with polygons in this status.', es: 'Ninguna celda con polígonos en ese estado.' },
    'qc.scopeBrazil': { pt: 'Mostrando células do Brasil inteiro', en: 'Showing cells from all of Brazil', es: 'Mostrando celdas de todo Brasil' },
    'qc.scopeState': { pt: 'Mostrando apenas células de {uf}', en: 'Showing only cells from {uf}', es: 'Mostrando solo celdas de {uf}' },
    'qc.stateOf': { pt: 'Estado', en: 'State', es: 'Estado' },
    'qc.loading': { pt: 'Carregando…', en: 'Loading…', es: 'Cargando…' },
    'qc.loadError': { pt: 'Erro ao carregar dados.', en: 'Failed to load data.', es: 'Error al cargar datos.' },
    'qc.saveError': { pt: 'Erro ao salvar revisão.', en: 'Failed to save review.', es: 'Error al guardar la revisión.' },
    'qc.noPolygons': { pt: 'Sem polígonos pendentes nesta célula.', en: 'No pending polygons in this cell.', es: 'Sin polígonos pendientes en esta celda.' },
    'qc.endOfQueue': { pt: 'Fim da fila desta célula.', en: 'End of queue for this cell.', es: 'Fin de la cola de esta celda.' },
    'qc.pendingOne': { pt: 'pendente', en: 'pending', es: 'pendiente' },
    'qc.pendingMany': { pt: 'pendentes', en: 'pending', es: 'pendientes' },
    'qc.since': { pt: 'desde', en: 'since', es: 'desde' },
    'qc.cellLabel': { pt: 'Célula', en: 'Cell', es: 'Celda' },
    'qc.creator': { pt: 'Autor:', en: 'Author:', es: 'Autor:' },
    'qc.area': { pt: 'Área:', en: 'Area:', es: 'Área:' },
    'qc.areaAtFocus': { pt: 'Referência ao focar', en: 'Baseline when focused', es: 'Referencia al enfocar' },
    'qc.statusLabel': { pt: 'Status:', en: 'Status:', es: 'Estado:' },
    'qc.exit': { pt: 'Sair do modo revisão (Esc)', en: 'Exit review mode (Esc)', es: 'Salir del modo revisión (Esc)' },
    'qc.prev': { pt: 'Anterior (←)', en: 'Previous (←)', es: 'Anterior (←)' },
    'qc.next': { pt: 'Próximo (→)', en: 'Next (→)', es: 'Siguiente (→)' },
    'qc.flag': { pt: 'Marcar para revisão futura (F)', en: 'Flag for later review (F)', es: 'Marcar para revisión posterior (F)' },
    'qc.flagBtn': { pt: 'Marcar', en: 'Flag', es: 'Marcar' },
    'qc.reject': { pt: 'Rejeitar (R)', en: 'Reject (R)', es: 'Rechazar (R)' },
    'qc.rejectBtn': { pt: 'Rejeitar', en: 'Reject', es: 'Rechazar' },
    'qc.approve': { pt: 'Aprovar (A)', en: 'Approve (A)', es: 'Aprobar (A)' },
    'qc.approveBtn': { pt: 'Aprovar', en: 'Approve', es: 'Aprobar' },
    'qc.unreview': { pt: 'Devolver para a fila (status pendente)', en: 'Send back to queue (pending status)', es: 'Devolver a la cola (estado pendiente)' },
    'qc.undo': { pt: 'Desfazer última edição (Ctrl+Z)', en: 'Undo last edit (Ctrl+Z)', es: 'Deshacer última edición (Ctrl+Z)' },
    'qc.undoBtn': { pt: 'Desfazer', en: 'Undo', es: 'Deshacer' },
    'qc.undone': { pt: 'Edição desfeita.', en: 'Edit undone.', es: 'Edición deshecha.' },
    'qc.hole': { pt: 'Adicionar buraco no polígono', en: 'Add hole to polygon', es: 'Agregar agujero al polígono' },
    'qc.holeBtn': { pt: 'Buraco', en: 'Hole', es: 'Agujero' },
    'qc.removeVertex': { pt: 'Clique num vértice para removê-lo', en: 'Click a vertex to remove it', es: 'Clic en un vértice para eliminarlo' },
    ...
    'qc.flagged': { pt: 'Polígono marcado para revisão futura.', en: 'Polygon flagged for later review.', es: 'Polígono marcado para revisión posterior.' },
    'qc.rejected': { pt: 'Polígono rejeitado.', en: 'Polygon rejected.', es: 'Polígono rechazado.' },
    'qc.reset': { pt: 'Polígono devolvido para a fila.', en: 'Polygon returned to queue.', es: 'Polígono devuelto a la cola.' },
    'qc.confirmReject': { pt: 'Tem certeza que quer rejeitar este polígono?', en: 'Are you sure you want to reject this polygon?', es: '¿Seguro que quiere rechazar este polígono?' },
    'qc.geometrySaved': { pt: 'Geometria salva.', en: 'Geometry saved.', es: 'Geometría guardada.' },
    'qc.revertedNoSave': { pt: 'Edições não salvas foram descartadas.', en: 'Unsaved edits were discarded.', es: 'Las ediciones no guardadas fueron descartadas.' },
    ...
    'tool.streetviewDisabledHint': {
      pt: 'Faça login e bloqueie uma célula para edição para usar o Street View.',
      en: 'Log in and lock a cell for editing to use Street View.',
      es: 'Inicie sesión y bloquee una celda para editar para usar Street View.'
    },
    ...
    'tool.drawShort': { pt: 'Desenhar', en: 'Draw', es: 'Dibujar' },
    ...
    'tool.editShort': { pt: 'Editar', en: 'Edit', es: 'Editar' },
    ...
    'tool.deletePolyShort': { pt: 'Excluir', en: 'Delete', es: 'Eliminar' },
    ...
    'admin.permanentDeleteModalTitle': { pt: 'Excluir usuário permanentemente', en: 'Permanently delete user', es: 'Eliminar usuario permanentemente' },
    'admin.permanentDeleteModalWarning': { pt: 'Esta ação é irreversível. O usuário "{0}" será removido; polígonos passam para "deleted".', en: 'This is irreversible. User "{0}" will be removed; polygons are reassigned to "deleted".', es: 'Es irreversible. El usuario "{0}" será eliminado; los polígonos pasan a "deleted".' },
    'admin.permanentDeleteTypeInstruction': { pt: 'Digite exatamente o texto abaixo para confirmar:', en: 'Type the text below exactly to confirm:', es: 'Escriba exactamente el texto siguiente para confirmar:' },
    'admin.permanentDeleteExpectedPhrase': { pt: 'EXCLUIR PERMANENTEMENTE {0}', en: 'PERMANENTLY DELETE {0}', es: 'ELIMINAR PERMANENTEMENTE {0}' },
    ...
    'admin.authMethodGoogle': { pt: 'Google', en: 'Google', es: 'Google' },
    'admin.authMethodEmail': { pt: 'E-mail / senha', en: 'Email / password', es: 'Correo / contraseña' },
    'admin.authMethodGoogleTitle': { pt: 'Conta vinculada ao Google (pode entrar com Google)', en: 'Account linked to Google (can sign in with Google)', es: 'Cuenta vinculada a Google (puede iniciar sesión con Google)' },
    'admin.authMethodEmailTitle': { pt: 'Apenas e-mail e senha (sem Google vinculado)', en: 'Email and password only (no Google linked)', es: 'Solo correo y contraseña (sin Google vinculado)' },
    ...
    'admin.locationState': { pt: 'Localização', en: 'Location', es: 'Ubicación' },
    'admin.editedState': { pt: 'Último estado editado', en: 'Last edited state', es: 'Último estado editado' },
    ...
    'profile.photoTooBig': { pt: 'Erro ao processar a foto. Tente outra imagem.', en: 'Error processing photo. Try another image.', es: 'Error al procesar la foto. Intente con otra imagen.' },
    ...
    'referral.label': { pt: 'Como conheceu a Leucaena.Earth? (opcional)', en: 'How did you find Leucaena.Earth? (optional)', es: '¿Cómo conoció Leucaena.Earth? (opcional)' },
    'referral.selectOption': { pt: '-- Selecionar --', en: '-- Select --', es: '-- Seleccionar --' },
    'referral.university': { pt: 'Universidade', en: 'University', es: 'Universidad' },
    'referral.instagram': { pt: 'Instagram', en: 'Instagram', es: 'Instagram' },
    'referral.linkedin': { pt: 'LinkedIn', en: 'LinkedIn', es: 'LinkedIn' },
    'referral.news': { pt: 'Reportagem / Notícia', en: 'News / Article', es: 'Reportaje / Noticia' },
    'referral.youtube': { pt: 'YouTube', en: 'YouTube', es: 'YouTube' },
    'referral.twitter': { pt: 'X (Twitter)', en: 'X (Twitter)', es: 'X (Twitter)' },
    'referral.facebook': { pt: 'Facebook', en: 'Facebook', es: 'Facebook' },
    'referral.friend': { pt: 'Indicação de amigo / colega', en: 'Friend / colleague referral', es: 'Recomendación de amigo / colega' },
    'referral.googleSearch': { pt: 'Busca no Google', en: 'Google Search', es: 'Búsqueda en Google' },
    'referral.event': { pt: 'Evento / Congresso', en: 'Event / Conference', es: 'Evento / Congreso' },
    'referral.other': { pt: 'Outro', en: 'Other', es: 'Otro' },
    'referral.detailPlaceholder': { pt: 'Especifique (ex.: nome da universidade, perfil, etc.)', en: 'Specify (e.g., university name, profile, etc.)', es: 'Especifique (ej.: nombre de la universidad, perfil, etc.)' },
    'referral.phUniversity': { pt: 'Nome da universidade ou curso', en: 'University or course name', es: 'Nombre de la universidad o curso' },
    'referral.phInstagram': { pt: 'Perfil ou página do Instagram', en: 'Instagram profile or page', es: 'Perfil o página de Instagram' },
    'referral.phLinkedin': { pt: 'Perfil ou publicação no LinkedIn', en: 'LinkedIn profile or post', es: 'Perfil o publicación en LinkedIn' },
    'referral.phNews': { pt: 'Nome da reportagem ou veículo', en: 'Article or outlet name', es: 'Nombre del reportaje o medio' },
    'referral.phYoutube': { pt: 'Canal ou vídeo no YouTube', en: 'YouTube channel or video', es: 'Canal o video de YouTube' },
    'referral.phTwitter': { pt: 'Perfil ou publicação no X', en: 'X profile or post', es: 'Perfil o publicación en X' },
    'referral.phFacebook': { pt: 'Página ou grupo no Facebook', en: 'Facebook page or group', es: 'Página o grupo de Facebook' },
    'referral.phFriend': { pt: 'Nome do amigo ou colega (opcional)', en: 'Friend or colleague name (optional)', es: 'Nombre del amigo o colega (opcional)' },
    'referral.phGoogleSearch': { pt: 'Termo pesquisado (opcional)', en: 'Search term (optional)', es: 'Término buscado (opcional)' },
    'referral.phEvent': { pt: 'Nome do evento ou congresso', en: 'Event or conference name', es: 'Nombre del evento o congreso' },
    'referral.phOther': { pt: 'Como você nos encontrou?', en: 'How did you find us?', es: '¿Cómo nos encontró?' },
    ...
    'profile.occupation': { pt: 'Ocupação', en: 'Occupation', es: 'Ocupación' },
    'profile.occupationPlaceholder': { pt: 'Ex.: Pesquisador, estudante…', en: 'E.g. Researcher, student…', es: 'Ej.: Investigador, estudiante…' },
    'profile.occupationTooLong': { pt: 'Ocupação deve ter no máximo 120 caracteres.', en: 'Occupation must be at most 120 characters.', es: 'La ocupación debe tener como máximo 120 caracteres.' },
    ...
    'toast.editNoPolygons': { pt: 'Não há polígonos para editar nesta célula. Esta ferramenta serve para editar polígonos já desenhados.', en: 'No polygons to edit in this cell. This tool is for editing polygons already drawn.', es: 'No hay polígonos para editar en esta celda. Esta herramienta sirve para editar polígonos ya dibujados.' },
    'toast.deleteNoPolygons': { pt: 'Não há polígonos que você possa excluir nesta célula. Esta ferramenta remove polígonos já desenhados (os seus ou, se for equipe, os permitidos pela regra de edição).', en: 'There are no polygons you can delete in this cell. This tool removes polygons already drawn (yours, or others if your role allows).', es: 'No hay polígonos que puedas eliminar en esta celda. Esta herramienta elimina polígonos ya dibujados (los tuyos u otros si tu rol lo permite).' },
    ...
    'collab.activity.drawing': { pt: 'Desenhando polígono', en: 'Drawing polygon', es: 'Dibujando polígono' },
    'collab.activity.deleting_poly': { pt: 'Excluindo polígono', en: 'Deleting polygon', es: 'Eliminando polígono' },
    'collab.activity.editing_poly': { pt: 'Editando polígono', en: 'Editing polygon', es: 'Editando polígono' },
    'collab.activity.drawing_hole': { pt: 'Desenhando buraco', en: 'Drawing hole', es: 'Dibujando agujero' },
    'collab.activity.adding_points': { pt: 'Adicionando pontos', en: 'Adding points', es: 'Agregando puntos' },
    'collab.activity.deleting_points': { pt: 'Removendo pontos', en: 'Removing points', es: 'Eliminando puntos' },
  ...
  function translatePage() {
    ...
    if (typeof LeucenaApp !== 'undefined' && LeucenaApp.refreshStreetViewTitleForLang) {
      LeucenaApp.refreshStreetViewTitleForLang();
    }
