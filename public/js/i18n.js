window.LeucenaI18n = (function () {
  ...
  const T = {
    ...
    'qc.save': { pt: 'Salvar geometria editada (S)', en: 'Save edited geometry (S)', es: 'Guardar geometría editada (S)' },
    'qc.saveBtn': { pt: 'Salvar', en: 'Save', es: 'Guardar' },
    'qc.saveApprove': { pt: 'Salvar geometria e aprovar', en: 'Save geometry and approve', es: 'Guardar geometría y aprobar' },
    'qc.saveApproveBtn': { pt: 'Salvar + Aprovar', en: 'Save + Approve', es: 'Guardar + Aprobar' },
    'qc.unreview': { pt: 'Devolver para a fila', en: 'Send back to queue', es: 'Devolver a la cola' },
